...
public class KafkaConnectAssemblyOperatorTest {
    ...
    public void testCreateCluster(TestContext context) {
        ...
        ops.createOrUpdate(new Reconciliation("test-trigger", AssemblyType.CONNECT, clusterCmNamespace, clusterCmName), clusterCm, createResult -> {
            ...
            if (connect.isMetricsEnabled()) {
                metricsNames.add(KafkaConnectCluster.metricConfigsName(clusterCmName));
            }
    ...
    public void testUpdateCluster(TestContext context) {
        ...
        ConfigMap metricsCm = new ConfigMapBuilder().withNewMetadata()
                    .withName(KafkaConnectCluster.metricConfigsName(clusterCmName))
                    .withNamespace(clusterCmNamespace)
                .endMetadata()
                .withData(Collections.singletonMap(AbstractModel.METRICS_CONFIG_FILE, METRICS_CONFIG))
                .build();
        when(mockCmOps.get(clusterCmNamespace, KafkaConnectCluster.metricConfigsName(clusterCmName))).thenReturn(metricsCm);
